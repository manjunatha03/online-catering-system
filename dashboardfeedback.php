...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed">
        <div class="navbar-header">
            <div class="navbar-text pull-right"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION["sh_admin"]; ?></div>
        </div>
    </nav>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <?php 
                                    ...
                                    $sql_feedback = "SELECT * FROM sh_feedback";
                                ...
                                <li class="active">
                                    <a href="dashboardfeedback.php"><i class="glyphicon glyphicon-envelope"></i> Feedbacks <span class="badge pull-right"><?php echo mysqli_num_rows($res_feedback); ?></span></a>
                                </li>
                                <?php
                                ?>
                                <li>
    ...
    <div class="box">
        ...
        {
            $output = '';
            $sql1 = "SELECT DISTINCT fullname FROM sh_feedback";
            ...
            while ($res = mysqli_fetch_array($data)) {
                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        ...
                        <a class="name" style="text-decoration:none;"><?php echo $res['fullname']; ?></a>
                    </li>
                </ul>
                <?php
            }
